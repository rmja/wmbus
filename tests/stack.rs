...
fn can_read_ffa() {
    ...
    assert_eq!(0x30, dll.address.version());
...
fn can_read_ffb() {
    ...
    let stack = Stack::new();
    let frame = &[
        0x13, 0x44, 0x2D, 0x2C, 0x78, 0x56, 0x34, 0x12, 0x01, 0x32, 0xA0, 0x00, 0x01, 0x02, 0x03,
        0x04, 0x05, 0x06, 0xC3, 0xC0,
    ];
    ...
    assert_eq!(0x01, dll.address.version());
